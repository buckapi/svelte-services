                        ...
                        <div class="logo-box">
                            <figure class="logo">
                                <a href="index.html" aria-label="Ir a la página principal">
                                    <img src="assets/images/logo-3.png" alt="Logo de la empresa">
                                </a>
                            </figure>
                        </div>
                        <div class="menu-area">
                            <!--Mobile Navigation Toggler-->
                            <div class="mobile-nav-toggler" aria-label="Abrir menú de navegación móvil">
                                <i class="icon-bar"></i>
                                <i class="icon-bar"></i>
                                <i class="icon-bar"></i>
                            </div>
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        <li><a href="/1" aria-label="Ir a sección 1">1</a></li>
                                        <li><a href="/2" aria-label="Ir a sección 2">2</a></li>
                                        <li><a href="/3" aria-label="Ir a sección 3">3</a></li>
                ...
                <div class="auto-container">
                    <div class="outer-box">
                        <div class="logo-box">
                            <figure class="logo">
                                <a href="index.html" aria-label="Ir a la página principal">
                                    <img src="assets/images/small-logo.png" alt="Logo pequeño de la empresa">
                                </a>
                            </figure>
                        </div>
                        <div class="menu-area">
        ...
        <div class="mobile-menu">
            ...
            <div class="close-btn">
                <i class="fas fa-times" aria-label="Cerrar menú móvil"></i>
            </div>
            
            <nav class="menu-box">
                <div class="nav-logo">
                    <a href="index.html" aria-label="Ir a la página principal">
                        <img src="assets/images/logo-2.png" alt="Logo del menú móvil">
                    </a>
                </div>
                ...
                <div class="social-links">
                    <ul class="clearfix">
                        <li><a href="index.html" aria-label="Visitar Twitter"><span class="fab fa-twitter"></span></a></li>
                        <li><a href="index.html" aria-label="Visitar Facebook"><span class="fab fa-facebook-square"></span></a></li>
                        <li><a href="index.html" aria-label="Visitar Pinterest"><span class="fab fa-pinterest-p"></span></a></li>
                        <li><a href="index.html" aria-label="Visitar Instagram"><span class="fab fa-instagram"></span></a></li>
                        <li><a href="index.html" aria-label="Visitar YouTube"><span class="fab fa-youtube"></span></a></li>
                    </ul>
                </div>
            </nav>
        </div><!-- End Mobile Menu -->